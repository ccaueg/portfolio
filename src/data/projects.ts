...
export const projects: Project[] = [
  {
    name: 'SmartFinance',
    description:
      'API REST para controle de gastos com análise de comportamento financeiro, permitindo registro e categorização de transações, acompanhamento de despesas e geração de insights sobre padrões de consumo. Conta com autenticação segura, versionamento de banco de dados, documentação API e suporte à execução em ambientes isolados.',
    tags: [
      'Java',
      'Spring Boot',
      'Spring Security',
  ...
  },
  {
    ...
    description:
      'API REST para encurtamento de URLs com geração automática de QR Codes. Backend estruturado com JPA/Hibernate e PostgreSQL, armazenamento de arquivos no AWS S3 e separação clara entre domínio e infraestrutura.',
    tags: [
      'Java',
      'Spring Boot',
      'JPA/Hibernate',
